<?php get_header(); ?>
	...
	<section class="pagetitle">
		<div class="wrapper">
			<div class="breadcrumb" style="font-size:1.12em;"><a href="<?php echo home_url(); ?> ">Home</a> > <a href="<?php echo home_url(); ?>/les-instruments-enseignes-dans-tous-les-styles">Filière instrumentale</a> > <?php the_title(); ?> </div>	
			<h1><?php the_title(); ?></h1>
		</div>
	</section>
	<section>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="wrapper">
				...
				<!-- <p><a href="<?php //echo home_url(); ?>/tarifs">> Voir les tarifs</a></p>
