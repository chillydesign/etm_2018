...
function generate_social_links($url, $title) {
    ...
    $str .= '<a title="Email" class="social_link" href="mailto:?body='. $encoded_title . ' : ' . $encoded_url .  '&subject=ETM" target="_blank" ><i class="fa fa-envelope" aria-hidden="true"></i><span>Email</span></a>';
