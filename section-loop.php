	...
	while ( have_rows('sections') ) : the_row();
		if( get_row_layout() == 'section_type' ) { ?>
			...
			<section class="<?php echo $backgroundclass . ' ' . $borderclass; ?> section_type">
				<div class="wrapper">
					<?php if(get_sub_field('contenu_toute_largeur')){ the_sub_field('content');} ?>
				</div>
						...
						if($image_position=="left") { ?>
							<div class="wrapper">
								<div class="row">
									...
									<div class="col-sm-6 col-sm-pull-6"><div style="width:100%; padding: 40%; background: url(<?php echo $url; ?>) no-repeat; background-size: 100% auto; margin-bottom:10px;;"></div></div>
								</div>
							</div>
						<?php } else { ?>
							<div class="wrapper">
								<div class="row">
									...
									<div class="col-sm-6"><div style="width:100%; padding: 40%; background: url(<?php echo $url; ?>) no-repeat; background-size: 100% auto; margin-bottom:10px;;"></div></div>
								</div>
							</div>
						<?php }
					}
		...
		<?php }
		 ...
		 elseif( get_row_layout() == 'section_speciale' ) {  //Slider
			...
			elseif($type_de_section == '3fullwidth') {
				$colonne1txt = get_sub_field('colonne1txt');
				$colonne1img = get_sub_field('colonne1img');
				$colonne2txt = get_sub_field('colonne2txt');
				$colonne2img = get_sub_field('colonne2img');
			...
			elseif($type_de_section == 'news') { ?>
			<section class="hidden-xss">
				<div class="wrapper">
					<h1 style="margin: 40px 0 40px 70px;">Events</h1>
										...
										<div class="eventboxwhite">
											<div class="row">
												<div class="col-md-8">
													...
													<div style="margin:10px 0;"><a href="<?php the_permalink(); ?>">> Lire la suite </a></div>
												</div>
												<div class="col-md-4 hidden-sm hidden-xs"><a href="<?php the_permalink(); ?>"><!-- <div style="width:100%; padding: 37%; background:url(<?php //echo $url;?>) no-repeat; background-size: cover; margin-bottom:20px; margin-top:6px;"></div> --><?php if(!empty($url)){?><img src="<?php echo $url; ?>"><?php } ?></a></div>
			...
			<?php }
			elseif ($type_de_section=="gmap_fullwidth") { ?>
					<?php $coordinates = strval(get_sub_field('google_map'));
					$google_map = '[chilly_map location="' . $coordinates . '"]'; ?>
