<?php get_header(); ?>
	...
	<section class="pagetitle">
				<div class="wrapper">
					<div class="breadcrumb"  style="font-size:1.12em;"><a href="<?php echo home_url(); ?> ">Home</a> > Cours collectifs et Ateliers > <a href="<?php echo home_url(); ?>/ateliers-par-style">Ateliers par style</a> > <?php the_title(); ?></div>
					<h1><?php the_title(); ?></h1>
				</div>
			</section>
	<section>
			...
			<div class="wrapper">
				 ...
				 <div class="row atelier">
				 	<div class="col-sm-6" style="padding-right : 30px;">
				 		<h3><?php if(get_sub_field('new')){echo '<strong>New</strong> - '; } ?><?php echo get_sub_field('title'); ?></h3>
