								...
								<section class="event">
									<div class="wrapper">
										<div class="row">
											...
											<div class="col-md-3 col-md-pull-9" style="padding: 0px 60px 0 0;"><a href="<?php echo $permalink; ?>"><!-- <div style="width:100%; padding: 37%; background:url(<?php //echo $url;?>) no-repeat; background-size: cover; margin-bottom:20px; margin-top:6px;"></div> --><img src="<?php echo $url; ?>" <?php if(get_field('photo_circulaire')){?> style="border-radius:50%;" <?php } ?>></a></div>
